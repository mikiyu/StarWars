	...
	public void printDetailsFilms(JsonArray results) {
		...
		if (results.size() != 0) {
			...
			for (int i = 0; i < results.size(); i++) {
				...
				System.out.println("Titulo : " + film.get("title"));
				System.out.println("episodio numero : " + film.get("episode_id"));
				JsonElement crawl = film.get("opening_crawl");
				String crawlfixed = crawl.toString().replace("\\r\\n", " ");
				System.out.println("Apertura : " + crawlfixed);
				System.out.println("Director : " + film.get("director"));
				System.out.println("Productor : " + film.get("producer"));
				System.out.println("Fecha de lanzamiento : " + film.get("release_date"));
			...
			System.out.println("Tu búsqueda no ha encontrado resultados");
		}
	}
